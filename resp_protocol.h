...
#define RESPNULL        "$-1\r\n"
#define RESPNULLLENGTH   5
#define RESPMAXDIGITLEN  26 // max RESP rendered digits in a decimal number + \r\n
...
ssize_t respGenerateReply(RESPROTO *rpp,byte **outBufp,size_t *outBufszp);
